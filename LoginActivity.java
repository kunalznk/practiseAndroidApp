...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    // these are also the varaiables 
    private static final int RC_SIGN_IN = 9001;
    private static final String TAG = "EmailPassword";
    private static final String TAG2 = "GoogleActivity";
    DatabaseReference mDatabaseRef;
    private Workout wr;
    // these are the variable referece for interact with layout
    public ProgressDialog mProgressDialog;
    // for e.g mDetailTextView is type TextView which is used to show the text
    ...
    // method which is used to show progressDailog 
    // which is the round loading icon 
    ...
    // method for validate input Date from the form
    ...
    @Override
    // intent after succesfull login to 
    // go to activity main scrren
